...
import com.michaelfotiadis.moviedb.data.loader.TvSeriesDetailsLoader;
...
public class TvSeriesDetailsActivity extends BaseActivity implements AppBarLayout.OnOffsetChangedListener {

    private static final String EXTRA = TvSeriesDetailsActivity.class.getSimpleName() + "_extra_1";
    ...
    private static final String FRAGMENT_TAG =
            TvSeriesDetailsActivity.class.getSimpleName() + "_fragment_tag";
    ...
    public static Intent getInstance(final Context context,
        ...
        final Intent intent = new Intent(context, TvSeriesDetailsActivity.class);
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_series_details));
        ...
        if (extras != null) {
            ...
            if (!TextUtils.isEmpty(id)) {
                ...
                addContentFragmentIfMissing(
                        TvSeriesDetailsFragment.newInstance(id),
                        FRAGMENT_TAG);
            }
        }
    ...
    private void loadData() {
        ...
        final TvSeriesDetailsLoader loader = new TvSeriesDetailsLoader(this);

        loader.setCallback(new DataFeedLoaderCallback<TvSeriesDetails>() {
            @Override
            ...
            @Override
            public void onSuccess(final List<TvSeriesDetails> result) {
    ...
    private void showResult(final TvSeriesDetails movieDetails) {
        updateUi();
        setTitle(movieDetails.getName());

        final TvSeriesDetailsHeaderViewHolder holder = new TvSeriesDetailsHeaderViewHolder(mHeaderLayout);

        final TvSeriesDetailsHeaderViewBinder binder = new TvSeriesDetailsHeaderViewBinder(
                this,
                getImageFetcher(),
                getIntentDispatcher()
        );
        ...
        if (fragment instanceof TvSeriesDetailsFragment) {
            ((TvSeriesDetailsFragment) fragment).setData(movieDetails);
        }
