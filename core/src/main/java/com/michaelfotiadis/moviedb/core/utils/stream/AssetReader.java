package com.michaelfotiadis.moviedb.core.utils.stream;
...
public class AssetReader {
    ...
    public <T> T fromJson(final String path, final Class<T> classOfT) {
        final String string = readToString(path, CoreConstants.ENCODING_UTF8);
    ...
    public String readAsString(final String path) {
        return readToString(path, CoreConstants.ENCODING_UTF8);
    }
    ...
    private String readToString(final String path, final String encoding) {
        ...
        try {
            ...
            CoreLog.e("Error reading Resource: " + path, e);
        } finally {
